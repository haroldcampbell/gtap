...
//     let shapeNodes = visual.shapeNodes
//     t.equal(shapeNodes[0].$radius(), 10);
//     t.equal(shapeNodes[1].$radius(), 10);
//     t.equal(shapeNodes[2].$radius(), 10);
//     t.end()
//   });
...
//     let shapeNodes = visual.shapeNodes
//     t.equal(shapeNodes[0].$radius(), 10);
//     t.equal(shapeNodes[1].$radius(), 15);
//     t.equal(shapeNodes[2].$radius(), 20);
//     t.end()
//   });

//   testCase.test("$arcRadiusInset() should decrement radius of each arc", t => {
//     const visual = setupFixture().visual;
//     visual.shapeNodes.forEach((v) => {
//       v.$radius(40);
//     })

//     $arcRadiusInset(5).action(visual);

//     let shapeNodes = visual.shapeNodes
//     t.equal(shapeNodes[0].$radius(), 40);
//     t.equal(shapeNodes[1].$radius(), 35);
//     t.equal(shapeNodes[2].$radius(), 30);
//     t.end()
//   });
...
//     const shapeNodes = visual.shapeNodes

//     $arcSpread(spreadData).action(visual);

//     const normalize = dataItem => dataItem / maxValue;
//     const actualArcSpan = shapeNodes.map(node => node.$arcSpan());
...
//     const actualArcSpan = shapeNodes.map(node => node.$arcSpan());
//     const actualStartAngles = shapeNodes.map(node => node.$startAngle());
...
//     t.equal(shapeNodes[0].$arcSpan(), 48);
//     /* 0.5 * 60 = 30 */
//     t.equal(shapeNodes[1].$arcSpan(), 30);
//     /* 1.0 * 60 = 60 */
//     t.equal(shapeNodes[2].$arcSpan(), 60);
//     t.end()
//   });
...
//       t.equal(shapeNodes[0].$startAngle(), 0);
//       t.equal(shapeNodes[1].$startAngle(), spanOffset * 1);
//       t.equal(shapeNodes[2].$startAngle(), spanOffset * 2);
//       t.end()
//     });
...
//       visual.shapeNodes.forEach((v, index) => {
...
//       t.equal(shapeNodes[0].$startAngle(), expected);

//       expected = startAngleInDegrees + spanOffset;
//       t.equal(shapeNodes[1].$startAngle(), expected);

//       expected = startAngleInDegrees + spanOffset * 2;
//       t.equal(shapeNodes[2].$startAngle(), expected);
//       t.end()
//     });
...
//       t.equal(shapeNodes[0].$startAngle(), 0);
//       t.equal(shapeNodes[1].$startAngle(), 48 + spanOffset);
//       t.equal(shapeNodes[2].$startAngle(), (48 + spanOffset) + (30 + spanOffset));
//       t.end()
//     });
...
//       let shapeNodes = visual.shapeNodes
//       const arcSpans = shapeNodes.map(node => node.$arcSpan());

//       $arcSpanInset(spanInset).action(visual);

//       t.equal(shapeNodes[0].$arcSpan(), arcSpans[0] - spanInset * 2);
//       t.equal(shapeNodes[1].$arcSpan(), arcSpans[1] - spanInset * 2);
//       t.equal(shapeNodes[2].$arcSpan(), arcSpans[2] - spanInset * 2);
//       t.end()
//     });
...
//       shapeNodes.forEach((_, index) => {
//         cumulativeSpan = (index == 0) ? spanInset : cumulativeSpan + shapeNodes[index - 1].$arcSpan();
//         expectedArcSpans[index] = cumulativeSpan;
//       });

//       $arcSpanInset(spanInset).action(visual);

//       t.equal(shapeNodes[0].$startAngle(), expectedArcSpans[0]);
//       t.equal(shapeNodes[1].$startAngle(), expectedArcSpans[1]);
//       t.equal(shapeNodes[2].$startAngle(), expectedArcSpans[2]);
//       t.end()
//     });
...
//       t.equal(shapeNodes[0].$startAngle(), 0);
//       t.equal(shapeNodes[1].$startAngle(), 0);
//       t.equal(shapeNodes[2].$startAngle(), 0);

//       $arcRotateBy(rotationInDegrees).action(visual);

//       t.equal(shapeNodes[0].$startAngle(), rotationInDegrees);
//       t.equal(shapeNodes[1].$startAngle(), rotationInDegrees);
//       t.equal(shapeNodes[2].$startAngle(), rotationInDegrees);
//       t.end()
//     });
...
//       let shapeNodes = visual.shapeNodes
//       t.equal(shapeNodes[0].$startAngle(), local.first);
//       t.equal(shapeNodes[1].$startAngle(), local.first + local.increment);
//       t.equal(shapeNodes[2].$startAngle(), local.first + local.increment * 2);
//       t.end()
//     });
...
//       t.equal(shapeNodes[0].$startAngle(), 0); /* Sanity check */
//       t.equal(shapeNodes[1].$startAngle(), 0);
//       t.equal(shapeNodes[2].$startAngle(), 0);

//       $arcLambda({}, callback).action(visual);

//       t.equal(shapeNodes[0].$startAngle(), 100);
//       t.equal(shapeNodes[1].$startAngle(), 100);
//       t.equal(shapeNodes[2].$startAngle(), 100);
//       t.end()
//     });
//   });
