...
test("$maxWidth", testCase => {
    ...
    testCase.test("complex data", t => {
        ...
        /**
         * Used an emptyShape instead of pointNode because _$.__attr(a, "width")
